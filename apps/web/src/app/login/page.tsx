  ...
  return (
    <main className="login-page">
      <section className="login-introduction">
        <Link className="brand login-brand" href="/dashboard" aria-label="BuildCore home"><span className="brand-mark" aria-hidden="true">B</span><span className="brand-word">Build<span>Core</span><small>Engineering</small></span></Link>
        <div className="login-intro-content"><p className="eyebrow">Built for the field and the office</p><h1>Clear projects. Confident decisions.</h1><p className="login-intro-copy">Bring daily site reporting, BOQ progress, variations, and valuations into one dependable workspace.</p><div className="login-benefits"><span>Live project visibility</span><span>BOQ-led progress</span><span>Controlled variations</span></div><div className="login-live-board" aria-hidden="true"><div className="login-live-board-head"><span className="login-live-dot" />Operational workspace <b>Live</b></div><div className="login-live-board-grid"><span><i />Site reports</span><span><i />BOQ progress</span><span><i />Change control</span></div></div><div className="login-brand-visual" aria-hidden="true"><span className="login-orbit login-orbit-one" /><span className="login-orbit login-orbit-two" /><Image src="/brand/buildcore-app-icon.png" alt="" fill sizes="(max-width: 800px) 0px, 280px" priority /></div><p className="login-trust">One workspace for Directors, Project Managers, Quantity Surveyors, and Site Engineers.</p></div>
      </section>
