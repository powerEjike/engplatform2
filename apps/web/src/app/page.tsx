...
export default function PublicHome() {
  ...
  return <main className="public-home">
    ...
    <section className="public-capabilities"><div><p className="eyebrow">Built for real project control</p><h2>Everything your delivery team needs in one place.</h2></div><div className="public-capability-grid"><article><span>01</span><h3>Daily reporting</h3><p>Capture site work, labour, equipment, observations, and issues while the day is still fresh.</p></article><article><span>02</span><h3>BOQ progress</h3><p>Turn completed quantities into a clear, reliable view of delivery progress.</p></article><article><span>03</span><h3>Variation control</h3><p>Raise, review, approve, and track project changes before they become commercial surprises.</p></article><article><span>04</span><h3>Valuations</h3><p>Prepare BOQ-based payment certificates using the work and approved changes already recorded.</p></article></div></section>
