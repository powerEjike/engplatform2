...
export default function NewVariationPage() {
  ...
  if (!canWorkOnProject(profile.role, user.uid, project)) return <main className="auth-loading">This variation form is only available for your assigned projects. <Link href="/dashboard">Return to your assigned projects</Link></main>;
